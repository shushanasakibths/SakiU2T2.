...
public class RectangleRunner {
    public static void main(String[] args) {
       ...
       int areaOfRect1 = rect1.calculateArea();
       double volumeOfRect1 = rect1.calculateBoxVolume(rect1Height);
       int areaOfRect2 = rect2.calculateArea();
       double volumeOfRect2 = rect2.calculateBoxVolume(rect2Height);

       System.out.println("Rectangle 1's Area: " + areaOfRect1 + ", Box Volume: " + volumeOfRect1);
       System.out.println("Rectangle 2's Area: " + areaOfRect2 + ", Box Volume: " + volumeOfRect2);
    }
}
